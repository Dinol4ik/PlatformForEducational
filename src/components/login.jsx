    ...
    return (
        <AnimationLayout>
            <Flex align={'center'} justify={'center'} h={500}>
                <motion.div
                    style={{borderRadius: '1em', border: '1px solid #0399E9', display: buttonDisplay}}
                    whileHover={{
                    ...
                    <Link
                        ...
                        <motion.svg width="40" height="23" viewBox="0 0 38 23" fill="none"
                            ...
                            <motion.path fillRule="evenodd" clipRule="evenodd"
                                         ...
                                         fill="#fff" fillOpacity="0" stroke="#0399E9" strokeLinecap="butt"
                                         strokeWidth="1.5" variants={pathVariants} initial="hidden" animate="visible"
                            />
                        </motion.svg>
                        <motion.div
